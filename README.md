...
- **Auto-confirm by default** — sign-ups are auto-confirmed with no emailed code so POC users get in frictionlessly; real email verification is an opt-in one-attribute switch.
